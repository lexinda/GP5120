...
//  GP5120
//
//  Created by 朱孟乐 on 14/11/10.
//  Copyright (c) 2014年 com.lexindasoft. All rights reserved.
//

#import "CarInfoDetailView.h"

@implementation CarInfoDetailView
...
-(void)drawRect:(CGRect)rect{
    ...
    UIImage *carInfo = [UIImage imageNamed:@"carInfo"];
    
    UIImageView *carInfoImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0.0, 0.0, self.frame.size.width, 30.0)];
    
    [carInfoImageView setImage:carInfo];
    
    [self addSubview:carInfoImageView];
    
    UILabel *peopleLabel = [[UILabel alloc] initWithFrame:CGRectMake(10.0, carInfoImageView.frame.size.height, 60.0, 20.0)];
    
    [peopleLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    
    [peopleLabel setText:@"发布人："];
    
    [self addSubview:peopleLabel];
    
    UILabel *peopleInfoLabel = [[UILabel alloc] initWithFrame:CGRectMake(peopleLabel.frame.origin.x+peopleLabel.frame.size.width, peopleLabel.frame.origin.y, (self.frame.size.width-60-60)/2, 20.0)];
    
    [peopleInfoLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    
    [peopleInfoLabel setText:[_carInfo people]];
    
    [self addSubview:peopleInfoLabel];
    
    UILabel *addressLabel = [[UILabel alloc] initWithFrame:CGRectMake(peopleInfoLabel.frame.origin.x+peopleInfoLabel.frame.size.width, peopleLabel.frame.origin.y, 60.0, 20.0)];
    
    [addressLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    
    [addressLabel setText:@"目的地："];
    
    [self addSubview:addressLabel];
    
    UILabel *addressInfoLabel = [[UILabel alloc] initWithFrame:CGRectMake(addressLabel.frame.origin.x+addressLabel.frame.size.width, addressLabel.frame.origin.y, (self.frame.size.width-60-60)/2, 20.0)];
    
    [addressInfoLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    ...
    [phoneLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    ...
    [phoneInfoLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    ...
    [otherLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    ...
    [getTimeLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    ...
    [getTimeInfoLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    
    [getTimeInfoLabel setText:[_carInfo getTime]];
    
    [self addSubview:getTimeInfoLabel];
    
    UILabel *boxLabel = [[UILabel alloc] initWithFrame:CGRectMake(getTimeLabel.frame.origin.x, getTimeLabel.frame.origin.y+getTimeLabel.frame.size.height, 50.0, 20.0)];
    
    [boxLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    ...
    [boxInfoLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    
    [boxInfoLabel setText:[_carInfo boxType]];
    
    [self addSubview:boxInfoLabel];
    
    UILabel *createTimeLabel = [[UILabel alloc] initWithFrame:CGRectMake(boxLabel.frame.origin.x, boxLabel.frame.origin.y+boxLabel.frame.size.height, 70.0, 20.0)];
    
    [createTimeLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    ...
    [createTimeInfoLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    ...
    UILabel *priceLabel = [[UILabel alloc] initWithFrame:CGRectMake(createTimeLabel.frame.origin.x, createTimeLabel.frame.origin.y+createTimeLabel.frame.size.height, 50.0, 20.0)];
    
    [priceLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    ...
    [priceInfoLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    
    [priceInfoLabel setText:[_carInfo price]];
    
    [self addSubview:priceInfoLabel];
    
    UILabel *infoTypeLabel = [[UILabel alloc] initWithFrame:CGRectMake(priceLabel.frame.origin.x,priceLabel.frame.origin.y+priceLabel.frame.size.height, 70.0, 20.0)];
    
    [infoTypeLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    ...
    [infoTypeInfoLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    ...
    [weightLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    ...
    [weightInfoLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    ...
    [portLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    ...
    [portInfoLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    
    [portInfoLabel setText:[_carInfo port]];
    
    [self addSubview:portInfoLabel];
    
    UILabel *transportTypeLabel = [[UILabel alloc] initWithFrame:CGRectMake(portInfoLabel.frame.origin.x+portInfoLabel.frame.size.width,infoTypeLabel.frame.origin.y+infoTypeLabel.frame.size.height, 70.0, 20.0)];
    
    [transportTypeLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
    ...
    [transportInfoLabel setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
