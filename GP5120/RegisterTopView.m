...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [middleButton setTitle:@"资料完善" forState:UIControlStateNormal];
        ...
        [rightButton setTitle:@"上传照片" forState:UIControlStateNormal];
...
-(void)pushView:(id)action{
    ...
    [_pushViewDelegate swapRegisterView:button.tag];
