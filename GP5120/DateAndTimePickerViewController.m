...
- (void)viewDidLoad {
    ...
    self.textFieldEnterDate = [[UITextField alloc] initWithFrame:CGRectMake(20.0, 100.0, self.view.frame.size.width-40.0, 20)];
    
    self.textFieldEnterDate.delegate=self;
    
    [self.view addSubview:self.textFieldEnterDate];
    
    self.customPicker = [[UIPickerView alloc] initWithFrame:CGRectMake(self.view.frame.origin.x, self.view.frame.size.height-249, self.view.frame.size.width, 249)];
    
    CALayer *pickerLayer = [CALayer layer];
    
    float height = 250;
    float width = self.view.frame.size.width;
    
    pickerLayer.frame = CGRectMake(self.view.frame.origin.x, self.view.frame.size.height-250, width, height);
    
    pickerLayer.backgroundColor = [UIColor colorWithWhite:0.8f alpha:1.0f].CGColor;
    
    [pickerLayer addSublayer:self.customPicker.layer];
    ...
    self.toolbarCancelDone = [[UIToolbar alloc] initWithFrame:CGRectMake(self.view.frame.origin.x, self.view.frame.size.height-290, self.view.frame.size.width, 40)];
    
    [self.toolbarCancelDone setBarStyle:UIBarStyleDefault];
...
//    
//    [cancelButton setFrame:CGRectMake(0.0, 0.0, 50.0, 50.0)];
//    
...
//    UIBarButtonItem *myCancelButton = [[ UIBarButtonItem alloc] initWithCustomView:cancelButton];
    
    UIBarButtonItem *flexibleSpace = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace target:nil action:nil];
//    [buttons addObject:myCancelButton];
